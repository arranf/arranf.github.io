    ...
    data() {
        return {
            ...
            awards: [
                ...
                {name: 'Driver Prize - Best Student in Computer Science', badge: {text: '2016 / 2017', position: 'right', type: 'warn'}},
                {name: 'Letter of Commendation', badge: {text: '2016 / 2017 / 2018', position: 'right', type: 'warn'}}
            ],
            modules: [
